/* ==========================================================================
   CloudAcc - Initial Sample Catalog Data
   Curated stock for mobile phone accessories store
   ========================================================================== */
...
export const INITIAL_SALES = [
  {
    ...
    items: [
      { id: 'prod-001', name: 'Funda Silicona Líquida Antigolpe MagSafe', price: 18.00, qty: 1, cost: 5.50 },
      { id: 'prod-009', name: 'Vidrio Templado Premium 9H Bordes Redondeados', price: 9.00, qty: 1, cost: 1.80 }
    ],
    subtotal: 27.00,
    discount: 0,
    tax: 0,
  ...
  },
  {
    ...
    customer: 'Marcos R.',
    items: [
      { id: 'prod-003', name: 'Cargador Rápido GaN 65W Doble USB-C', price: 34.00, qty: 1, cost: 14.00 },
      { id: 'prod-011', name: 'Cable Tipo-C a Tipo-C Carga Ultra Rápida 100W', price: 13.00, qty: 1, cost: 3.80 }
    ],
    subtotal: 47.00,
    discount: 2.00,
    tax: 0,
  ...
  },
  {
    ...
    customer: 'Lucía V.',
    items: [
      { id: 'prod-005', name: 'Audífonos In-Ear Bluetooth TWS ANC', price: 45.00, qty: 1, cost: 16.00 }
    ],
    subtotal: 45.00,
    discount: 0,
    tax: 0,
...
export const INITIAL_SETTINGS = {
  ...
  currency: 'USD',
  taxRate: 0, // 0 for retail price inclusive
  ticketFooter: '¡Gracias por su compra! Garantía de 30 días en cargadores y accesorios electrónicos.',
  phone: '+1 (555) 019-2834',
  address: 'Av. Tecnológica 404, Local 12',
  cloudSync: {
    enabled: true,
    provider: 'supabase', // 'supabase' | 'firebase' | 'rest'
